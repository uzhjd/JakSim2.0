...
VALUES ('uzhjd1004', 1, 'TXXXXXXXX', 0, '2023/06/13', 1, 2);

# 정상적인 PT권
INSERT INTO PAYMENT (USER_ID, TP_IDX, TID, P_STATUS, P_A_DT, P_PT_PERIOD, P_PT_CNT)
VALUES ('uzhjd1004', 6, 'T1XXXXXXX', 0, '2023/07/18', 90, 22);
INSERT INTO PAYMENT (USER_ID, TP_IDX, TID, P_STATUS, P_A_DT, P_PT_PERIOD, P_PT_CNT)
VALUES ('uzhjd1004', 11, 'T2XXXXXXX', 0, '2023/06/20', 90, 36);
INSERT INTO PAYMENT (USER_ID, TP_IDX, TID, P_STATUS, P_A_DT, P_PT_PERIOD, P_PT_CNT)
VALUES ('uzhjd1004', 21, 'T3XXXXXXX', 0, '2023/07/23', 90, 30);

# 환불
INSERT INTO PAYMENT (USER_ID, TP_IDX, TID, P_STATUS, P_A_DT, P_PT_PERIOD, P_M_DT, P_PT_CNT)
VALUES ('uzhjd1004', 20, 'T4XXXXXXX', 1, '2023/07/20', 90, '2023/07/21', 30);