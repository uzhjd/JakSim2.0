...
VALUES ('wkdgyfla97', 5, 30, '2023/06/17' , 30, 1);

INSERT INTO PAYMENT (USER_ID, TP_IDX, P_PT_CNT, P_M_DT, P_PT_PERIOD, P_REFUND)
VALUES ('gse96', 5, 30, '2023/06/30' , 30, 1);
...
INSERT INTO PAYMENT (USER_ID, TP_IDX, P_PT_CNT, P_M_DT, P_PT_PERIOD, P_REFUND)
VALUES ('gse1234', 42, 1, '2023/06/17', 4, 1);

INSERT INTO PAYMENT (USER_ID, TP_IDX, P_PT_CNT, P_M_DT, P_PT_PERIOD, P_REFUND)
VALUES ('humble', 6, 10, '2023/06/17', 30, 1);

INSERT INTO PAYMENT (USER_ID, TP_IDX, P_PT_CNT, P_M_DT, P_PT_PERIOD, P_REFUND)
VALUES ('hye8997', 41, 1, '2023/06/17', 4, 1);

INSERT INTO PAYMENT (USER_ID, TP_IDX, P_PT_CNT, P_M_DT, P_PT_PERIOD, P_REFUND)
VALUES ('test96', 5, 5, '2023/06/17', 30, 1);
VALUES ('gse96', 42, 1, '2023/06/20', 60, 1);
