...
# 정상적인 PT권
INSERT INTO PAYMENT (USER_ID, TP_IDX, TID, P_STATUS, P_A_DT, P_PT_PERIOD, P_PT_CNT)
VALUES ('uzhjd1004', 2, 'T1XXXXXXX', 0, '2023/07/18', 90, 22);
INSERT INTO PAYMENT (USER_ID, TP_IDX, TID, P_STATUS, P_A_DT, P_PT_PERIOD, P_PT_CNT)
VALUES ('uzhjd1004', 3, 'T2XXXXXXX', 0, '2023/06/20', 90, 36);
INSERT INTO PAYMENT (USER_ID, TP_IDX, TID, P_STATUS, P_A_DT, P_PT_PERIOD, P_PT_CNT)
VALUES ('uzhjd1004', 4, 'T3XXXXXXX', 0, '2023/07/23', 90, 30);

# 환불
INSERT INTO PAYMENT (USER_ID, TP_IDX, TID, P_STATUS, P_A_DT, P_PT_PERIOD, P_M_DT, P_PT_CNT)
VALUES ('uzhjd1004', 5, 'T4XXXXXXX', 1, '2023/07/20', 90, '2023/07/21', 30);